...
GITHUB_CONFIG_AUTH_TOKEN = 'oauth_access_token'
...
GITHUB_REPO_NAME_INCORRECT_MSG = 'Incorrect format found for provided repo name. Please enter repo name in the ' \
...
GITHUB_ROLE_MAINTAINER = 'maintainer'
